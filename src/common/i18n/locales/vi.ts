...
export const en: Texts = {
  ...
  openAutoSavingDirectory: "Mở thư mục lưu tự động",
  exportPositionImage: "Xuất ảnh thế cờ",
  ...
  appendSpecialMove: "Chèn nước đi đặc biệt",
  ...
  largerFontSize: "Cỡ chữ lớn",
  smallerFontSize: "Cỡ chữ nhỏ",
  settings: "Cài đặt",
  config: "Thiết lập",
  debug: "Gỡ lỗi",
  ...
  drawsAreHalfWin: "Hòa bằng nửa ván thắng",
  zValue: "Giá trị Z",
  ...
  csaProtocolV121WithPVComment: "Phương thức CSA 1.2.1 có bình luận PV",
  hostToConnect: "Tên máy chủ",
  portNumber: "Cổng",
  password: "Mật khẩu",
  ...
  declareWinning: "Tuyên bố chiến thắng",
  research: "Tính toán",
  ...
  imageHasMarginsRemoveToDisplayLarger: "Ảnh có lề (loại bỏ để hiển thị lớn hơn)",
  ...
  displayFileAndRank: "Hiện hàng và cột",
  displayLeftControls: "Hiện điều khiển bên trái",
  displayRightControls: "Hiện điều khiển bên phải",
  tabViewStyle: "Hiện thẻ",
  oneColumn: "1 cột",
  twoColumns: "2 cột",
  sounds: "Âm thanh",
  pieceLoudness: "Âm lượng quân",
  clockLoudness: "Âm lượng đồng hồ",
  clockPitch: "Cao độ đồng hồ",
  ...
  bgContain: "Phóng to",
  bgTile: "Mảnh ghép",
  inaccuracy: "Nước đi khó hiếu",
  dubious: "Nước đi không tốt",
  mistake: "Sai lầm",
  blunder: "Sai lầm ngớ ngẩn",
  inaccuracyThreshold: "Ngưỡng nước đi khó hiếu",
  dubiousThreshold: "Ngưỡng nước không tốt",
  mistakeThreshold: "Ngưỡng sai lầm",
  blunderThreshold: "Ngưỡng sai lầm ngỡ ngần",
  gothic: "Gothic",
  mincho: "Minh thể",
  ...
  supportsKIF_KI2_CSA_USI_SFEN_JKF: "*Hỗ trợ KIF, KI2, CSA, USI, SFEN, và JKF.",
  ...
  pieceVolumeMustBe0To100Percent: "Âm lượng quân phải từ 0% đến 100%.",
  clockVolumeMustBe0To100Percent: "Âm lượng đồng hồ phải từ 0% đến 100%.",
  clockPitchMustBe220To880Hz: "Cao độ đồng hồ phải từ 220Hz đến 880Hz.",
